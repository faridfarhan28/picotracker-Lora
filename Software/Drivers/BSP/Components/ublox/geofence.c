...
LoRaMacRegion_t current_loramac_region = LORAMAC_REGION_US915;  // Loramac region AS923
Polygon_t curr_poly_region = US902928_NAMERICA_polygon; // Indonesia is in this polygon
